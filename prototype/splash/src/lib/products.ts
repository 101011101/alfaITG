...
export const PRODUCTS: Product[] = [
  {
    ...
    category: "Automation",
    icon: Workflow,
    image: "/media/images/industrial/robot-welding.webp",
    relatedIds: [2, 4],
    status: "completed",
    energy: 100,
  },
  {
    ...
    category: "Security",
    icon: ShieldCheck,
    image: "/media/images/industrial/robot-asrs.webp",
    relatedIds: [1, 3],
    status: "completed",
    energy: 88,
  },
  {
    ...
    category: "Robotics",
    icon: Bot,
    image: "/media/images/industrial/robot-cobot.webp",
    relatedIds: [2, 4],
    status: "in-progress",
    energy: 72,
  },
  {
    ...
    icon: Sparkles,
    image: "/media/images/industrial/robot-fleet.webp",
    relatedIds: [1, 5],
    status: "in-progress",
    energy: 64,
  },
  {
    ...
    category: "Workforce",
    icon: GraduationCap,
    image: "/media/images/industrial/robot-cleanroom.webp",
    relatedIds: [4, 6],
    status: "pending",
    energy: 48,
  },
  {
    ...
    category: "Strategy",
    icon: Eye,
    image: "/media/images/industrial/robot-palletizing.webp",
    relatedIds: [1, 5],
    status: "pending",
    energy: 32,
  },
...
export const COMPANY: Product[] = [
  ...
  },
  {
    ...
    category: "Mission",
    icon: Target,
    image: "/media/images/industrial/robot-polishing.webp",
    relatedIds: [2, 4],
    status: "completed",
    energy: 72,
  },
  ...
  },
  {
    ...
    icon: Building2,
    image: "/media/images/hero/f22-pair-inflight.webp",
    relatedIds: [4, 6],
    status: "in-progress",
    energy: 48,
  },
  {
    ...
    category: "Foundation",
    icon: Sprout,
    image: "/media/images/schematic/engine-cutaway.webp",
    relatedIds: [1, 5],
    status: "pending",
    energy: 36,
  },
